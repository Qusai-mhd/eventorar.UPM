...
urlpatterns = [
    ...
    path('event/published_events',adminViews.PublishedEventListView.as_view(),name='published-events-list'),

    path('home',endUserViews.EndUUserPublishedEventListView.as_view(),name='home'),
